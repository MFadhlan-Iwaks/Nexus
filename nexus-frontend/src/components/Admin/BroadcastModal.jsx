...
export default function BroadcastModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("SIRENE DIGITAL DIAKTIFKAN!\nBroadcast peringatan dini telah berhasil dikirim ke seluruh perangkat relawan di zona target.");
    onClose();
  };
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-5">
          ...
          <div className="bg-amber-50 p-3 rounded-xl flex gap-3 border border-amber-100">
            ...
            <p className="text-xs text-amber-800 leading-relaxed font-medium">
              Gunakan fitur ini hanya untuk keadaan darurat atau himbauan resmi. Pesan akan langsung muncul di layar utama (dashboard) seluruh relawan.
            </p>
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              rows="4" 
              placeholder="Tuliskan arahan evakuasi atau informasi penting untuk relawan di lapangan..."
            ></textarea>
          </div>
