...
import { ShieldAlert, LayoutDashboard, Package, Ambulance, History, Building2, LogOut, X } from 'lucide-react';
import { useRouter } from 'next/navigation';

export default function Sidebar({ activeTab, setActiveTab, isOpen, setIsOpen, activeInstitution }) {
      ...
      `}>
        ...
        <div className="p-4 bg-slate-800/50 mb-2 border-b border-slate-800">
          ...
          <div className="flex items-center gap-2 text-white font-semibold text-sm">
            <Building2 size={16} className="text-blue-400" /> {activeInstitution || 'Instansi Aktif'}
          </div>
        </div>
